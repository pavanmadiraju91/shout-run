...
export function Header() {
  const { user, liveSessions } = useStore();
    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-shout-bg/80 border-b border-shout-border">
      <div className="max-w-screen-2xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <span className="text-xl font-bold font-mono tracking-tight">shout</span>
        ...
        <nav className="flex items-center gap-6">
          <Link
            href="/"
            className="text-sm text-shout-muted hover:text-shout-text transition-colors flex items-center gap-2"
          >
            Live Feed
            {liveCount > 0 && (
          ...
          <Link
            href="/about"
            className="text-sm text-shout-muted hover:text-shout-text transition-colors"
          >
            About
          </Link>
          ...
          <button
            onClick={toggleTheme}
            className="p-2 text-shout-muted hover:text-shout-text transition-colors rounded-lg hover:bg-shout-surface"
          ...
          {user ? (
            ...
            <a
              ...
              className="flex items-center gap-2 text-sm bg-shout-surface border border-shout-border rounded-lg px-4 py-2 hover:border-shout-muted transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="currentColor"
